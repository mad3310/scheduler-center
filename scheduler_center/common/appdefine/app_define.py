...
define('admins', default = ("zhoubingzheng <zhoubingzheng@letv.com>", "zhangzeng <zhangzeng@letv.com>", "wangzhen3 <wangzhen3@letv.com>", "liuhao1 <liuhao1@letv.com>", "yaofaliang <yaofaliang@letv.com>", "yaokuo <yaokuo@letv.com>", "zhangxiang <zhangxiang@letv.com>", ), help = 'admin email address')
